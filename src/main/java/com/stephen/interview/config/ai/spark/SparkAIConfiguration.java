package com.stephen.interview.config.ai.spark;

import com.stephen.interview.config.ai.spark.condition.SparkAICondition;
import com.stephen.interview.config.ai.spark.properties.SparkAIProperties;
